...
# HaritsGH's Web Portofolio

This repo is for my web portofolio that I can share with other people. I'm planning to just use HTML and CSS only for now, while being hosted on Github Pages. I also would like to update it as I learn software engineering and fill it with my completed projects. You can visit it by clicking [here](https://revou-fsse-oct25.github.io/milestone-1-HaritsGH/). (Always be careful when clicking a random link)
...
4. A way to get in touch with me.

## Implemented Features

As of 7 November 2025, these features have been implemented:
- Navigation at the top of the page to jump to the selected section
